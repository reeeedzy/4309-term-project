...
<head>
	...
	<title>Privacy Policy - Roma's Pizza & Italian Restaurant</title>
	<link rel="stylesheet" href="style.css">
</head>

<body>
	<?php echo $nav ?>
	<h1>Privacy Policy of Roma's Pizza &amp; Italian</h1>

	<p>Roma's Pizza &amp; Italian operates the http://ctec4309.rmt9456.uta.cloud/term-project/ website, which provides
		the SERVICE.</p>

	<p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of
		Personal Information if anyone decided to use our Service, the Roma's website.</p>
	...
	<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible
		at http://ctec4309.rmt9456.uta.cloud/term-project/, unless otherwise defined in this Privacy Policy.</p>
