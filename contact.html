			...
			<div class="row">
				...
				<div class="col-xs-6 col-md-3 col-lg-2">
					...
					<ul class="unstyled inline">
						...
						<li>
							<a
								class="links"
								href="https://maps.app.goo.gl/vVY8QDRWaMRh36cW6"
								target="_blank"
								>7033 Greenville Ave. Dallas, TX 75231
							</a>
						</li>
					</ul>
				</div>
				...
				<div class="col-xs-6 col-md-3 col-lg-2">
					...
					<ul class="unstyled inline">
						...
						<li>
							<a class="links" href="https://www.facebook.com/RomasDallas"
								>Facebook</a
							>
						</li>
					</ul>
					...
					<ul class="unstyled inline">
						<li>
							<a
								href="https://www.linkedin.com/company/romaspizzadallas/"
								target="_blank"
					...
					<ul class="unstyled inline">
						<li>
							<a href="https://twitter.com/romasdallas" target="_blank"
						...
						<li>
							<a
								class="links"
								href="https://twitter.com/romasdallas"
								target="_blank"
								>Twitter/X</a
							>
						</li>
