			...
			<div class="row">
				<div class="col-xs-6 col-md-3">
					<div class="promosecond__image">
						<a href="order.html"
							><img src="images/promo1.png" alt="Promo Image 1"
						/></a>
					</div>
				</div>
				<div class="col-xs-6 col-md-3">
			...
			<div class="row promo-row">
				<div class="col-xs-6 col-md-3">
					<div class="promofirst__text">
						...
						<a href="order.html" class="btn btn-secondary">Order Online</a>
					</div>
				</div>
				<div class="promo-div2 col-xs-6 col-md-3">
					...
					<section class="second-section">
						<div class="second-section__content">
							...
							<div class="second-section__icons">
								<a
									href="https://www.facebook.com/your-restaurant-page"
									target="_blank"
									><i class="fab fa-facebook-f"></i
								></a>
								<a
									href="https://www.twitter.com/your-restaurant-page"
									target="_blank"
									><i class="fab fa-x-twitter"></i
								></a>
								<a
									href="https://www.instagram.com/your-restaurant-page"
									target="_blank"
